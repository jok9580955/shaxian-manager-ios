...
const promotionalText = {
  "ar-SA": "سجّل تقرير اليوم، المخزون، العملاء والتدفق النقدي لمحل الوجبات الخفيفة في دقائق، مع تنبيهات نقص المواد.",
  ca: "Registra vendes, inventari, clients i caixa del teu petit local en minuts, amb alertes de materials baixos.",
  cs: "Zapište denní tržby, sklad, zákazníky i cashflow malého bistra během pár minut, s upozorněním na nízký stav surovin.",
  da: "Registrér dagens salg, lager, kunder og cashflow i din lille madbutik på få minutter, med advarsler om lav beholdning.",
  "de-DE": "Erfassen Sie Tagesumsatz, Lager, Kunden und Cashflow Ihres Imbisses in Minuten, mit Warnungen bei niedrigem Bestand.",
  el: "Καταγράψτε πωλήσεις, απόθεμα, πελάτες και ταμειακή ροή για το μικρό σας κατάστημα σε λίγα λεπτά.",
  "en-AU": "Track daily sales, inventory, customers and cashflow for your small food shop in minutes, with low-stock alerts.",
  "en-CA": "Track daily sales, inventory, customers and cashflow for your small food shop in minutes, with low-stock alerts.",
  "en-GB": "Track daily sales, inventory, customers and cashflow for your small food shop in minutes, with low-stock alerts.",
  "en-US": "Track daily sales, inventory, customers and cashflow for your small food shop in minutes, with low-stock alerts.",
  "es-ES": "Registra ventas, inventario, clientes y caja de tu pequeño local en minutos, con avisos de bajo stock.",
  "es-MX": "Registra ventas, inventario, clientes y flujo de efectivo de tu fonda en minutos, con alertas de bajo inventario.",
  fi: "Kirjaa myynti, varasto, asiakkaat ja kassavirta pienessä ruokakaupassasi minuuteissa, myös vähäisen varaston hälytykset.",
  "fr-CA": "Suivez ventes, stock, clients et caisse de votre petit commerce en quelques minutes, avec alertes de stock bas.",
  "fr-FR": "Suivez ventes, stock, clients et caisse de votre petit commerce en quelques minutes, avec alertes de stock bas.",
  he: "נהלו מכירות יומיות, מלאי, לקוחות ותזרים מזומנים לעסק מזון קטן בדקות, עם התראות על מלאי נמוך.",
  hi: "अपनी छोटी फूड शॉप की रोज़ बिक्री, स्टॉक, ग्राहक और नकदी प्रवाह मिनटों में दर्ज करें, कम स्टॉक अलर्ट सहित।",
  hr: "Zabilježite dnevnu prodaju, zalihe, kupce i novčani tok male zalogajnice u nekoliko minuta, uz upozorenja za niske zalihe.",
  hu: "Rögzítse napi eladásait, készletét, ügyfeleit és pénzáramát kis étkezdéjében percek alatt, készlethiány-jelzésekkel.",
  id: "Catat penjualan harian, stok, pelanggan, dan arus kas usaha makanan kecil dalam hitungan menit, dengan peringatan stok rendah.",
  it: "Registra vendite, scorte, clienti e cassa del tuo piccolo locale in pochi minuti, con avvisi di scorte basse.",
  ja: "小さな飲食店の売上、在庫、顧客、資金の流れを数分で記録。材料不足のアラートにも対応。",
  ko: "작은 음식점의 일일 매출, 재고, 고객, 현금 흐름을 몇 분 안에 기록하고 부족 재고 알림도 확인하세요.",
  ms: "Catat jualan harian, stok, pelanggan dan aliran tunai kedai makanan kecil dalam beberapa minit, dengan amaran stok rendah.",
  "nl-NL": "Registreer omzet, voorraad, klanten en kasstroom van je kleine eetzaak in minuten, met meldingen bij lage voorraad.",
  no: "Registrer daglig salg, lager, kunder og kontantstrøm for din lille matbutikk på minutter, med varsler om lav beholdning.",
  pl: "Zapisuj dzienną sprzedaż, zapasy, klientów i przepływ gotówki małego lokalu w kilka minut, z alertami niskiego stanu.",
  "pt-BR": "Registre vendas, estoque, clientes e fluxo de caixa do seu pequeno negócio de comida em minutos, com alertas de estoque baixo.",
  "pt-PT": "Registe vendas, stock, clientes e fluxo de caixa do seu pequeno negócio de comida em minutos, com alertas de stock baixo.",
  ro: "Înregistrați vânzări, stoc, clienți și flux de numerar pentru micul local în câteva minute, cu alerte de stoc redus.",
  ru: "Ведите продажи, склад, клиентов и денежный поток небольшого кафе за минуты, с предупреждениями о низком запасе.",
  sk: "Zapíšte denné tržby, sklad, zákazníkov a cashflow malej prevádzky za pár minút, s upozornením na nízke zásoby.",
  sv: "Registrera daglig försäljning, lager, kunder och kassaflöde för din lilla matbutik på minuter, med varningar om lågt lager.",
  th: "บันทึกยอดขาย สต็อก ลูกค้า และกระแสเงินสดของร้านอาหารเล็ก ๆ ได้ในไม่กี่นาที พร้อมเตือนสต็อกต่ำ",
  tr: "Küçük yemek işletmenizin günlük satış, stok, müşteri ve nakit akışını dakikalar içinde kaydedin; düşük stok uyarılarıyla.",
  uk: "Ведіть продажі, склад, клієнтів і грошовий потік невеликого кафе за хвилини, з попередженнями про низькі запаси.",
  vi: "Ghi doanh thu, tồn kho, khách hàng và dòng tiền của quán ăn nhỏ trong vài phút, kèm cảnh báo sắp hết hàng.",
  "zh-Hans": "几分钟记录店铺日报、材料库存、客户和净流水，低库存及时提醒，适合沙县小吃和小型餐饮店每天使用。",
  "zh-Hant": "幾分鐘記錄店鋪日報、材料庫存、客戶和淨流水，低庫存及時提醒，適合沙縣小吃和小型餐飲店每天使用。",
};
...
const missingPromotionalText = existingLocales.filter((locale) => !promotionalText[locale]);
if (missingPromotionalText.length > 0) {
  throw new Error(`missing promotional text translations for: ${missingPromotionalText.join(", ")}`);
}
...
for (const locale of existingLocales) {
  ...
  for (const [file, value] of Object.entries({
    ...
    "promotional_text.txt": promotionalText[locale],
  })) {
